...
from mod.const import screen, WX, WY, BLACK, WHITE, MS_MINCHO_COL, FONT_SIZE_POPUP_MESSAGE, WHITE, BLACK

class _Queue:
    def __init__(self, text: str, color: tuple[int, int, int] = BLACK) -> None:
        kuro_text = MS_MINCHO_COL(text, FONT_SIZE_POPUP_MESSAGE, BLACK).convert_alpha()
        siro_text = MS_MINCHO_COL(text, FONT_SIZE_POPUP_MESSAGE, WHITE).convert_alpha()
