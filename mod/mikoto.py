...
class Mikoto():
    ...
    def _simote_make(self) -> None:
        ...
        from kaiketus.m02o import n_1, n_2, n_3, n_4, n_5, n_6
        self.yamahuda = yamahuda_factory.maid_by_cards(cards=[], hoyuusya=self.hoyuusya)
        self.tehuda = tehuda_factory.maid_by_cards(cards=[m00b.n_4, m00b.n_5, m00b.n_6, n_1, n_2, n_3, n_4, n_5, n_6, m00a.n_9], hoyuusya=self.hoyuusya)
